...
class MainUi(Tk):
    ...
    def __on_country_selected(self, name, overviews, nodes_box_ptr):
        self.__ftpipe.generate_nodes_map(overviews[name], name, True)
    ...
    def __generate_map_on_country_selected(self, name, overwrite = False):
        self.__ftpipe.generate_map(name, True)
    def __create_widgets(self):
        ...
        text_field_city_exception.grid(row = 3, column = 0, padx=15, pady=15)
